...
function updatePageTitle(lang) {
    if (lang === 'ja') {
        document.title = 'Value Create キャリア支援 | AIエンジニアの方へ - Tokyo AI Community公式パートナー';
    } else {
        document.title = 'Value Create Career Support | For AI Engineers - Tokyo AI Community Official Partner';
    }
}
